...
from torch_conv_kan.kan_convs import KALNConv2DLayer, KANConv2DLayer, KACNConv2DLayer, FastKANConv2DLayer, KAGNConv2DLayer, BottleNeckKAGNConv2DLayer
...
class UKANet(nn.Module):
    def __init__(self,
        ...
        self.output = nn.Conv2d(8 * block.expansion  * width_scale, num_classes, kernel_size=1, padding=0, stride=1, device=device)
